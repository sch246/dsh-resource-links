...
(
  ...
  node node_modules/typescript/bin/tsc -b packages/client/ui-primitives/tsconfig.json packages/client/ui-chat/tsconfig.json packages/extensions/cordis-client-runner/tsconfig.json --pretty false
)
for package in client/ui-primitives client/ui-chat extensions/cordis-client-runner; do
  (
