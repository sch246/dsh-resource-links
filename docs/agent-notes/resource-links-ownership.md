...
File-drop routing and conversation/attachment adaptation are independently owned by `@dsh-external/dsh-file-drop`. For a combined historical receipt, preserve and verify the old contributions before transferring ownership; [transfer guidance](scoped-file-drops.md) describes the responsibilities.
